...
CQuadrangleMesh::CQuadrangleMesh(ID3D11Device *pd3dDevice, float fWidth, float fHeight) : CMeshTexturedIlluminated(pd3dDevice)
{
	m_nVertices = 6;
...
CQuadrangleMesh::~CQuadrangleMesh()
{
}

void CQuadrangleMesh::GetDot(XMFLOAT3 &a, XMFLOAT3 &b, XMFLOAT3 &c)
{
