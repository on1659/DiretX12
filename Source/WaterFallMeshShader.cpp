...
CWaterFallMeshShader::CWaterFallMeshShader(std::unique_ptr<CMesh> pMesh, int nObjects) : CInstancedObjectsShader(nObjects)
{
}

CWaterFallMeshShader::CWaterFallMeshShader(std::unique_ptr<CMesh> pMesh) : CInstancedObjectsShader(0)
{
}

CWaterFallMeshShader::CWaterFallMeshShader(int nObjects) : CInstancedObjectsShader(nObjects)
{
}

CWaterFallMeshShader::~CWaterFallMeshShader()
{
}
...
void CWaterFallMeshShader::Render(ID3D11DeviceContext *pd3dDeviceContext, std::shared_ptr<CCamera> pCamera)
{
	...
	*/
	...
	CONTENTMGR->OMSetBlendingState(pd3dDeviceContext, "BillBoardSprite");
